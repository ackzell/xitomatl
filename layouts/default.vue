...
const toggleCreateTaskDialogVisibility = () => {
  isCreateTaskDialogShown.value = !isCreateTaskDialogShown.value
}
</script>

<template>
  <header relative flex justify-between items-center px-4 py-2>
    <div>
